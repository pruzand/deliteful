define([
	...
	var commonSuite = {
		...
		"Default State": function () {
			...
			assert.equal(cb.checked.toString(), elt.getAttribute("aria-checked"),
				"Unexpected 'aria-checked' attribute for wrapped input.");
		...
		"checked": function () {
			...
			var v = inp.getAttribute("aria-checked");
			assert.isNotNull(v, "Missing 'aria-checked' attribute");
			assert.isTrue(v === cb1.checked.toString(), "Unexpected value for 'aria-checked' attribute.");
		},
